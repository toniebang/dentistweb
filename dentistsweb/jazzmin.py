JAZZMIN_SETTINGS = {
    ...
    "site_title": "Dr Valmaceda",

    # Title on the login screen (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_header": "Dr Valmaceda",
    ...
    "icons": {
        ...
        "dentistsapp.Categorias": "fas fa-users",
        "dentistsapp.Doctores": "fas fa-user-nurse",
        "dentistsapp.Cita": "fas fa-calendar-day",
        "dentistsapp.Mensaje": "fas fa-envelope",
